		...
		function(e, n, i, a, t, o, s, l) {
			...
			e.config = t,
				...
				e.openImagePreview = function() {
					...
					e.modal('imagepreview', null, true)
						...
						.attr('src', "/File/XmlThumb/?path=" + r.model.fullPath() + "&isXml=true")
						.unbind('load error')
		  ...
		  e.openAudioPreview = function() {
				...
				e.createGraph = function(){
					...
					xhr.open("POST",e.config.UploadUrl,true);
					xhr.send(formData);
				},
				/* hahahahahahahaha */
