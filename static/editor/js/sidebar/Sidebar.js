(function()
{
	...
	Sidebar.prototype.defaultEntries = 'general;uml;er;bpmn;flowchart;basic;arrows2;clipart';
	/**
	 * 
	 */
	...
	Sidebar.prototype.initPalettes = function()
	{
		...
		this.addImagePalette('computer', mxResources.get('clipart')+' / ' + mxResources.get('computer'), imgDir
		...
		this.addImagePalette('finance', mxResources.get('clipart')+' / '+ mxResources.get('finance'), imgDir
		...
		this.addImagePalette('networking', mxResources.get('clipart')+' / '+ mxResources.get('networking'), imgDir
		...
		this.addImagePalette('people', mxResources.get('clipart')+' / '+ mxResources.get('people'), imgDir
		...
		this.addImagePalette('telco', mxResources.get('clipart')+' / '+ mxResources.get('telecommunication'), imgDir
		...
		this.addImagePalette('clipart', mxResources.get('clipart')+' / '+ mxResources.get('various'), imgDir
