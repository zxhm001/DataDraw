...
window.STORE_IMG_URL = window.STORE_IMG_URL || '/Image/StoreImage';
window.XML_TOKEN_URL = window.XML_TOKEN_URL|| '/Upload/Token';
window.IMG_TOKEN_URL = window.IMG_TOKEN_URL|| '/Image/Token';
window.ILL_TOKEN_URL = window.ILL_TOKEN_URL|| '/Illustrator/Token';
window.PROXY_URL =  window.PROXY_URL || '/proxy.php';
